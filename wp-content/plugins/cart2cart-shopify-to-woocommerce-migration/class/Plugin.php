...
class Plugin
{
  const PLUGINS_TITLE = 'Cart2cart: Shopify to Woocommerce Plugin';

  const APP_LINK = 'https://woocommerce.app.shopping-cart-migration.com/';
  const PUBLIC_SITE_LINK = 'https://woocommerce.app.shopping-cart-migration.com/';

  const URL_LIMIT = 'from-shopify-to-woocommerce';
  const SOURCE_CART_ID = 'Shopify';
